...
apply(lasso_MSE, 2, mean)
apply(lasso_MSE, 2, sd)
```
###Random Forest
```{r}
...
apply(forest_MSE, 2, mean)
apply(forest_MSE, 2, sd)
...
apply(support_MSE, 2, mean)
apply(support_MSE, 2, sd)
